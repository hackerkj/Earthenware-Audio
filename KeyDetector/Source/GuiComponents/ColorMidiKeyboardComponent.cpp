...
//==============================================================================
ColorMidiKeyboardComponent::ColorMidiKeyboardComponent (MidiKeyboardState& stateToUse, Orientation orientationToUse)
...
//==============================================================================
void ColorMidiKeyboardComponent::setVelocity (float v, bool useMousePosition)
{
    velocity = v;
...
//==============================================================================
void ColorMidiKeyboardComponent::setMidiChannel (int midiChannelNumber)
{
...
void ColorMidiKeyboardComponent::setMidiChannelsToDisplay (int midiChannelMask)
{
...
//==============================================================================
void ColorMidiKeyboardComponent::clearKeyMappings()
{
    resetAnyKeysInUse();
    keyPressNotes.clear();
    keyPresses.clear();
...
void ColorMidiKeyboardComponent::setKeyPressForNote (const KeyPress& key, int midiNoteOffsetFromC)
{
...
void ColorMidiKeyboardComponent::removeKeyPressForNote (int midiNoteOffsetFromC)
{
...
void ColorMidiKeyboardComponent::setKeyPressBaseOctave (int newOctaveNumber)
{
...
//==============================================================================
void ColorMidiKeyboardComponent::resetAnyKeysInUse()
{
...
void ColorMidiKeyboardComponent::updateNoteUnderMouse (const MouseEvent& e, bool isDown)
{
    updateNoteUnderMouse (e.getEventRelativeTo (this).position, isDown, e.source.getIndex());
}

void ColorMidiKeyboardComponent::updateNoteUnderMouse (Point<float> pos, bool isDown, int fingerNum)
{
...
void ColorMidiKeyboardComponent::repaintNote (int noteNum)
{
...
void ColorMidiKeyboardComponent::mouseMove (const MouseEvent& e)
{
    updateNoteUnderMouse (e, false);
}

void ColorMidiKeyboardComponent::mouseDrag (const MouseEvent& e)
{
...
void ColorMidiKeyboardComponent::mouseDown (const MouseEvent& e)
{
    auto newNote = getNoteAndVelocityAtPosition (e.position).note;
...
void ColorMidiKeyboardComponent::mouseUp (const MouseEvent& e)
{
    updateNoteUnderMouse (e, false);
...
void ColorMidiKeyboardComponent::mouseEnter (const MouseEvent& e)
{
    updateNoteUnderMouse (e, false);
}

void ColorMidiKeyboardComponent::mouseExit (const MouseEvent& e)
{
    updateNoteUnderMouse (e, false);
}

void ColorMidiKeyboardComponent::timerCallback()
{
...
bool ColorMidiKeyboardComponent::keyStateChanged (bool /*isKeyDown*/)
{
...
bool ColorMidiKeyboardComponent::keyPressed (const KeyPress& key)
{
    return keyPresses.contains (key);
}

void ColorMidiKeyboardComponent::focusLost (FocusChangeType)
{
    resetAnyKeysInUse();
}

//==============================================================================
void ColorMidiKeyboardComponent::drawKeyboardBackground (Graphics& g, Rectangle<float> area)
{
...
void ColorMidiKeyboardComponent::drawWhiteNote (int midiNoteNumber, Graphics& g, Rectangle<float> area,
...
void ColorMidiKeyboardComponent::drawBlackNote (int midiNoteNumber, Graphics& g, Rectangle<float> area,
...
String ColorMidiKeyboardComponent::getWhiteNoteText (int midiNoteNumber)
{
...
void ColorMidiKeyboardComponent::colourChanged()
{
...
//==============================================================================
void ColorMidiKeyboardComponent::drawWhiteKey (int midiNoteNumber, Graphics& g, Rectangle<float> area)
{
...
void ColorMidiKeyboardComponent::drawBlackKey (int midiNoteNumber, Graphics& g, Rectangle<float> area)
{
...
//==============================================================================
void ColorMidiKeyboardComponent::handleNoteOn (MidiKeyboardState*, int /*midiChannel*/, int /*midiNoteNumber*/, float /*velocity*/)
{
    noPendingUpdates.store (false);
}

void ColorMidiKeyboardComponent::handleNoteOff (MidiKeyboardState*, int /*midiChannel*/, int /*midiNoteNumber*/, float /*velocity*/)
{
    noPendingUpdates.store (false);
}
